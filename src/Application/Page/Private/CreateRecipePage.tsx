...
export const CreateRecipePage = () => {
    ...
    const [descriptionIngredien, setDescriptionIngredien] = useState("")
    ...
    const addIngredient = () => {
        const ingredient: IngredientType = {
            id: idIngredient,
            name: nameIngredient,
            description: descriptionIngredien,
        ...
        <>
            <div>
                ...
                <Flex w={500} justify={"center"} direction={"column"} align={"center"}>
                    ...
                    <Input placeholder="Ajouter une description" value={descriptionIngredien} onChange={
                        (event) => {
                            setDescriptionIngredien(event.currentTarget.value)
                        }
                    }/>
